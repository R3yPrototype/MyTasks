...
def get_db_connection():
    try:
        return pymysql.connect(
             host=os.environ.get('127.0.0.1'),  # Hostul bazei de date
            user=os.environ.get('root'),  # Utilizator
            password=os.environ.get('Nitn3lav3al0cin'),  # Parola
            database=os.environ.get('todousers'),  # Numele bazei de date
            port=3306 
        )
